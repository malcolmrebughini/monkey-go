...
import (
	...
	"github.com/malcolmrebughini/monkey-go/object"
	"github.com/malcolmrebughini/monkey-go/parser"
...
func TestBuiltinFunctions(t *testing.T) {
	...
	for _, tt := range tests {
		...
		case int:
			testIntergerObject(t, evaluated, int64(expected))
		case string:
			errObj, ok := evaluated.(*object.Error)
			require.True(t, ok)
...
func testIntergerObject(t *testing.T, obj object.Object, expected int64) {
